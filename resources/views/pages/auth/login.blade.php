...
@section('auth')
    <section class="relative">
        ...
        <div
            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-lg border border-gray-300">
            <div class="flex gap-4 border-b border-gray-300 pb-4 mb-4">
                ...
                <div class="mt-4">
                    ...
                    <h3 class="text-red-600 font-bold text-lg">PHẦN MỀM QUẢN LÝ HẬU CẦN</h3>
                </div>
            </div>
            <div class="flex">
                    ...
                    <form action="{{ route('postLogin') }}" method="post">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <input type="password" name="password" id="password" placeholder="Mật khẩu"
                                ...
                                autocomplete="">
                            <button type="submit"
                                class="bg-blue-600 text-white p-2 rounded-lg mt-4 hover:bg-blue-700 transition">
                                Đăng nhập
                            </button>
                        </div>
                    </form>
